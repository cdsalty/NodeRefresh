...
// console.log(__dirname); // provides a directory path to app.js alone
// console.log(path.join(__dirname, '../public')); // returns /Users/christopher/Desktop/NODE/web-server/public
...
// this also replaced my help page and my setup page routes
app.get('', (req, res) => {
